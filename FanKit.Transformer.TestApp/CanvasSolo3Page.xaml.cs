...
{
    /// <summary>
    /// <see cref="SettingsDialog3"/>
    /// <see cref="CanvasOperator3"/>
    ///
    /// <see cref="Fit2"/>
    /// <see cref="CanvasTransformer3"/>
    /// </summary>
    public abstract partial class CanvasSolo3Page : Page
    {
        //@Const
        const float CW = 512f;
        const float CH = 512f;
        ...
        public readonly CanvasTransformer3 Canvas = new CanvasTransformer3(CW / 2f, CH / 2f);
        ...
        public CanvasSolo3Page()
        {
            ...
            this.CanvasOperator.Right_Start += (x, y) =>
            {
                ...
                bool isScale = this.SettingsDialog.RightScale;
                bool isRotate = this.SettingsDialog.RightRotate;
            ...
            this.CanvasOperator.Right_Delta += (x, y) =>
            {
                ...
                {
                    this.Canvas.Push2(this.StartingPoint, this.Point);
                }
                else
                {
                    this.Canvas.Push3(this.StartingPoint, this.Point);
                }
            ...
            {
                this.StartingPivot = this.Pivot = new Pivot3(x1, y1, x2, y2);
                this.Canvas.CachePinch(this.StartingPivot.Center);
            };
            this.TouchPad.Double_Delta += (x1, y1, x2, y2) =>
            {
                this.Pivot = new Pivot3(x1, y1, x2, y2);

                bool isScale = this.SettingsDialog.DoubleScale;
                bool isRotate = this.SettingsDialog.DoubleRotate;
                ...
                {
                    this.Canvas.Pinch2(this.StartingPivot.RotationAngle, this.Pivot.RotationAngle, this.Pivot.Center);
                }
                else
                {
            ...
            {
                bool isScale = this.SettingsDialog.WheelScale;
                ...
                {
                    if (d > 0)
                        this.Canvas.TwistClockwise(this.Point);
                    else
                        this.Canvas.TwistCounterclockwise(this.Point);
                }
            ...
            this.CanvasHub.RotateChanged += (s, e) =>
            {
                this.Canvas.Rotation = (float)e.NewValue / 180f * System.MathF.PI;
