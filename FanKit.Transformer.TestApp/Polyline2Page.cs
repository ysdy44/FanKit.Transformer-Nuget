...
namespace FanKit.Transformer.TestApp
{
    ...
    /// </summary>
    public sealed partial class Polyline2Page : SoloPage
    {
        //@Key
        ...
        private void CacheSingle2()
        {
            ...
            switch (this.Indexer.Mode)
            {
                case SegmentIndexerMode.None:
                    ...
                    this.Inserter = new SegmentInserter(out this.FootPoint, this.Layer.Segments, this.Layer.IsClosed, this.Point, ls);
