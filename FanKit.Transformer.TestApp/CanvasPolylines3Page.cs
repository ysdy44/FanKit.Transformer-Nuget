...
namespace FanKit.Transformer.TestApp
{
    ...
    /// </summary>
    public sealed partial class CanvasPolylines3Page : CanvasSolo3Page
    {
        //@Key
            ...
            switch (this.Indexer.Mode)
            {
                    ...
                    for (int k = 0; k < this.Layers.Count; k++)
                    {
                        ...
                        if (item.IsSelected)
                        {
                            for (int j = 0; j < item.Figures.Count; j++)
                            {
                                ...
                                this.Inserter = new SegmentInserter(out this.FootPoint, NodePointUnits.Normal, figure.Segments, figure.IsClosed, this.Position, ls);
                                ...
                                this.Composer.ResetByPoint(this.FootPoint.Foot);
                                this.HasRectChoose = false;
                                this.Invalidate(InvalidateModes.CanvasControl);
                                return;
                            }
                ...
                case SegmentIndexerMode.PointWithoutChecked:
...

                    {
                        ...
                        this.Composer.ResetByPoint(segment.Map);
