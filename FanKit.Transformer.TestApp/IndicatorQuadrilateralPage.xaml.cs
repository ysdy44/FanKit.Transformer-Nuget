...
{
    public sealed partial class IndicatorQuadrilateralPage : Page
    {
        //@Key
        ...
        static readonly Quadrilateral ResetDestination = new Quadrilateral
        {
        ...
        Quadrilateral StartingDestination = ResetDestination;
        Quadrilateral Destination = ResetDestination;
        bool DisableSlider = false;

        public IndicatorQuadrilateralPage()
        {
            ...
            this.XSlider.ValueChanged += (s, e) =>
            {
                ...
                this.Destination = Quadrilateral.TranslateX(this.StartingDestination, translateX);
            ...
            this.YSlider.ValueChanged += (s, e) =>
            {
                ...
                this.StartingDestination = this.Destination;
                this.Destination = Quadrilateral.TranslateY(this.StartingDestination, translateY);
            ...
            this.RotationSlider.ValueChanged += (s, e) =>
            {
                ...
                this.StartingDestination = this.Destination;
                this.Destination = Quadrilateral.Transform(this.StartingDestination, hostMatrix);
        ...
        private void ResetUI()
        {
            ...
            this.Point2XRun.Text = this.Destination.RightBottom.X.ToString();
            this.Point2YRun.Text = this.Destination.RightBottom.Y.ToString();

            this.Point3XRun.Text = this.Destination.LeftBottom.X.ToString();
            this.Point3YRun.Text = this.Destination.LeftBottom.Y.ToString();

            this.Line30.X2 = this.Line01.X1 = this.Destination.LeftTop.X;
            this.Line30.Y2 = this.Line01.Y1 = this.Destination.LeftTop.Y;

            this.Line01.X2 = this.Line12.X1 = this.Destination.RightTop.X;
            this.Line01.Y2 = this.Line12.Y1 = this.Destination.RightTop.Y;

            this.Line12.X2 = this.Line23.X1 = this.Destination.RightBottom.X;
            this.Line12.Y2 = this.Line23.Y1 = this.Destination.RightBottom.Y;

            this.Line23.X2 = this.Line30.X1 = this.Destination.LeftBottom.X;
            this.Line23.Y2 = this.Line30.Y1 = this.Destination.LeftBottom.Y;
