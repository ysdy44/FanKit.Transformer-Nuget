...
{
    public sealed partial class ContainsBoundsPage : Page
    {
        // Source
        Rect Source;
        ...
        public ContainsBoundsPage()
        {
            ...
            this.CanvasControl.PointerMoved += (s, e) =>
            {
                ...
                {
                    case 0:
                        this.Dest2 = new Bounds(this.Position.X, this.Position.Y, this.Position.X + 72f, this.Position.Y + 72f);
                        break;
                    case 1:
                        this.Dest2 = new Bounds(this.Position.X, this.Position.Y, this.Position.X - 72f, this.Position.Y - 72f);
                        break;
        ...
        private void Draw(CanvasDrawingSession drawingSession)
        {
            ...
            if (this.Dest1.Contains(this.Dest2))
            {
            ...
            {
                drawingSession.DrawLine(this.Dest2.Left, this.Dest2.Top, this.Dest2.Right, this.Dest2.Top, LeftStrokeColor, 3f);
                drawingSession.DrawLine(this.Dest2.Right, this.Dest2.Top, this.Dest2.Right, this.Dest2.Bottom, LeftStrokeColor, 3f);
                drawingSession.DrawLine(this.Dest2.Right, this.Dest2.Bottom, this.Dest2.Left, this.Dest2.Bottom, LeftStrokeColor, 3f);
                drawingSession.DrawLine(this.Dest2.Left, this.Dest2.Bottom, this.Dest2.Left, this.Dest2.Top, LeftStrokeColor, 3f);
            }
