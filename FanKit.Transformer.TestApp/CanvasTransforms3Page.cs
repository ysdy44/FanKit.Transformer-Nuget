...
{
    /// <summary>
    /// <see cref="DemoHostTriangle3"/>
    /// </summary>
    public sealed partial class CanvasTransforms3Page : CanvasSolo3Page
    {
        //@Key
        ...
        private void CacheSingle1()
        {
            ...
            Bounds bounds = new Bounds(this.StartingPosition, this.Position, this.KeepRatio, this.CenteredScaling);
            Layer createNew = new Layer(width, height, new Triangle(bounds))
            {
                IsSelected = true,
            };

            createNew.UpdateCanvas(this.Canvas);
