...
namespace FanKit.Transformer.TestApp
{
    ...
    /// </summary>
    public sealed partial class CanvasPolyline2Page : CanvasSolo2Page
    {
        //@Key
        ...
        {
            drawingSession.DrawDashActualPolyline(this.Layer.Segments, this.Layer.IsClosed, this.Layer.ActualStrokeWidth);
        ...
        private void CacheSingle2()
        {
            ...
            this.Indexer = new SegmentIndexer(this.Layer.Segments, this.StartingPoint, ds);
            ...
            switch (this.Indexer.Mode)
            {
                case SegmentIndexerMode.None:
                    ...
                    this.Inserter = new SegmentInserter(out this.FootPoint, NodePointUnits.Normal, this.Layer.Segments, this.Layer.IsClosed, this.Position, ls);
                ...
                case SegmentIndexerMode.PointWithoutChecked:
                    {
                        ...
                        this.Composer.ResetByPoint(segment.Point);
        ...
        private void Over2()
        {
            ...
            this.Indexer = new SegmentIndexer(this.Layer.Segments, this.Point, ds);
            ...
            switch (this.Indexer.Mode)
            {
                case SegmentIndexerMode.None:
                    ...
                    {
                        this.FootPoint = new FootPointer(NodePointUnits.Normal, this.Layer.Segments, this.Layer.IsClosed, this.Position, ls);
                        if (this.FootPoint.Contains)
                        {
                            this.Invalidate(InvalidateModes.CanvasControl);
                            return;
