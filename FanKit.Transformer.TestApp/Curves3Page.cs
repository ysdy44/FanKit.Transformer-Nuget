...
using Layer = FanKit.Transformer.Demos.DemoCurve2;
using Figure = FanKit.Transformer.Curves.Figure2;
using Segment = FanKit.Transformer.Curves.Segment2;
using InvalidateModes = FanKit.Transformer.Sample.InvalidateModes1345;
...
namespace FanKit.Transformer.TestApp
{
    ...
    /// </summary>
    public sealed partial class Curves3Page : SoloPage
    {
        //@Key
        ...
        bool NodeCenteredScaling => this.IsCtrl || this.ToolBox9.CenteredScaling;
        bool NodeKeepRatio => this.IsShift || this.ToolBox9.KeepRatio;
        ...
        readonly DemoHostTriangle3 Transformer = new DemoHostTriangle3();
                ...
                new Figure
                {
                    Segments =
                    {
                        new Segment
                        {
                            ...
                            Raw = new Node
                            {
                                Point = new Vector2(X1 - 144.6047f, Y1 - 138.5997f),
                                LeftControlPoint= new Vector2(X1 - 144.6047f, Y1 - 138.5997f),
                                RightControlPoint = new Vector2(X1 - 144.6047f, Y1 - 138.5997f),
                            }
                        },
                        new Segment
                        {
                            ...
                            Raw = new Node
                            {
                                Point = new Vector2(X1 + 13.37953f, Y1 - 95.3983f),
                                LeftControlPoint = new Vector2(X1 - 8.623611f, Y1 - 132.9995f),
                                RightControlPoint= new Vector2(X1 + 35.38268f, Y1 - 57.79712f),
                            }
                        },
                        new Segment
                        {
                            ...
                            Raw = new Node
                            {
                                Point = new Vector2(X1 - 12.58583f, Y1 + 87.00745f),
                                LeftControlPoint = new Vector2(X1 - 34.4567f, Y1 + 48.00778f),
                                RightControlPoint= new Vector2(X1 + 9.285034f, Y1 + 126.0071f),
                            }
                        },
                        new Segment
                        {
                ...
                new Figure
                {
                    Segments =
                    {
                        new Segment
                        {
                            ...
                            Raw = new Node
                            {
                                Point = new Vector2(X2 - 144.6047f, Y2 - 138.5997f),
                                LeftControlPoint= new Vector2(X2 - 144.6047f, Y2 - 138.5997f),
                                RightControlPoint = new Vector2(X2 - 144.6047f, Y2 - 138.5997f),
                            }
                        },
                        new Segment
                        {
                            ...
                            Raw = new Node
                            {
                                Point = new Vector2(X2 + 13.37953f, Y2 - 95.3983f),
                                LeftControlPoint = new Vector2(X2 - 8.623611f, Y2 - 132.9995f),
                                RightControlPoint= new Vector2(X2 + 35.38268f, Y2 - 57.79712f),
                            }
                        },
                        new Segment
                        {
                            ...
                            Raw = new Node
                            {
                                Point = new Vector2(X2 - 12.58583f, Y2 + 87.00745f),
                                LeftControlPoint = new Vector2(X2 - 34.4567f, Y2 + 48.00778f),
                                RightControlPoint= new Vector2(X2 + 9.285034f, Y2 + 126.0071f),
                            }
                        },
                        new Segment
                        {
        ...
        readonly ToolBox9 ToolBox9 = new ToolBox9
        {
            Visibility = Visibility.Collapsed,
        ...
        public Curves3Page()
        {
            ...
            this.Children.Add(this.ToolBox9);
            ...
            this.TopBar.ToolTypeChanged += delegate
            {
                switch (this.TopBar.ToolType)
                {
                    case ToolType2.Transform:
                        ...
                        this.ToolBox9.Visibility = Visibility.Collapsed;
                        break;
                    ...
                    case ToolType2.NodeTransform:
                        ...
                        this.ToolBox4.Visibility = Visibility.Collapsed;
                        this.ToolBox5.Visibility = Visibility.Collapsed;
                        this.ToolBox9.Visibility = Visibility.Visible;
                        break;
                    default:
                        break;
                }
            ...
            this.ToolBox9.CloseClick += delegate { this.NodeClose(); };
            this.ToolBox9.OpenClick += delegate { this.NodeOpen(); };
            this.ToolBox9.RemoveClick += delegate { this.NodeRemove(); };
            this.ToolBox9.SharpClick += delegate { this.NodeSharp(); };
            this.ToolBox9.SmoothClick += delegate { this.NodeSmooth(); };
        ...
        public override void Draw(ICanvasResourceCreator resourceCreator, CanvasDrawingSession drawingSession)
        {
            ...
            switch (this.TopBar.ToolType)
            {
                ...
                case ToolType2.NodeMove: this.Draw1(drawingSession); this.Draw2(resourceCreator, drawingSession); break;
                ...
                switch (this.TopBar.ToolType)
                {
                    ...
                    case ToolType2.NodeTransform:
                        switch (this.Composer.PointsDistribution)
                        {
                            ...
                            case ComposerPointsDistribution.RowLine: this.Indicator.ChangeAll(this.Composer.LinePoint0, this.Composer.LinePoint1, this.ParameterPanel.RowLineAnchorMode); break;
                            case ComposerPointsDistribution.ColumnLine: this.Indicator.ChangeAll(this.Composer.LinePoint0, this.Composer.LinePoint1, this.ParameterPanel.ColumnLineAnchorMode); break;
        ...
        private void SingleRow5()
        {
            switch (this.LineMode)
            {
                ...
                case LineContainsNodeMode.Handle0:
                    this.Composer.LineElongatePoint0(this.Indicator, this.ParameterPanel.RowLineAnchorMode, this.StartingPoint, this.Point);
                ...
                case LineContainsNodeMode.Handle1:
                    this.Composer.LineElongatePoint1(this.Indicator, this.ParameterPanel.RowLineAnchorMode, this.StartingPoint, this.Point);
                ...
                case LineContainsNodeMode.Handle:
                    if (this.HasStepFrequency)
                        this.Composer.LineRotate(this.Indicator, this.ParameterPanel.RowLineAnchorMode, this.Point, StepFrequency);
                    else
                        this.Composer.LineRotate(this.Indicator, this.ParameterPanel.RowLineAnchorMode, this.Point);
                ...
                case LineContainsNodeMode.Center:
                    this.Composer.LineTranslate(this.Indicator, this.ParameterPanel.RowLineAnchorMode, this.StartingPoint, this.Point);
                ...
                case LineContainsNodeMode.Point0:
                    this.Composer.LineMovePoint0(this.Indicator, this.ParameterPanel.RowLineAnchorMode, this.Point);
                ...
                case LineContainsNodeMode.Point1:
                    this.Composer.LineMovePoint1(this.Indicator, this.ParameterPanel.RowLineAnchorMode, this.Point);
        ...
        private void SingleColumn5()
        {
            switch (this.LineMode)
            {
                case LineContainsNodeMode.None:
                    ...
                    break;
                case LineContainsNodeMode.Handle0:
                    this.Composer.LineElongatePoint0(this.Indicator, this.ParameterPanel.ColumnLineAnchorMode, this.StartingPoint, this.Point);
                    ...
                    break;
                case LineContainsNodeMode.Handle1:
                    this.Composer.LineElongatePoint1(this.Indicator, this.ParameterPanel.ColumnLineAnchorMode, this.StartingPoint, this.Point);
                ...
                case LineContainsNodeMode.Handle:
                    if (this.HasStepFrequency)
                        this.Composer.LineRotate(this.Indicator, this.ParameterPanel.ColumnLineAnchorMode, this.Point, StepFrequency);
                    else
                        this.Composer.LineRotate(this.Indicator, this.ParameterPanel.ColumnLineAnchorMode, this.Point);
                    ...
                    break;
                case LineContainsNodeMode.Center:
                    this.Composer.LineTranslate(this.Indicator, this.ParameterPanel.ColumnLineAnchorMode, this.StartingPoint, this.Point);
                    ...
                    break;
                case LineContainsNodeMode.Point0:
                    this.Composer.LineMovePoint0(this.Indicator, this.ParameterPanel.ColumnLineAnchorMode, this.Point);
                    ...
                    break;
                case LineContainsNodeMode.Point1:
                    this.Composer.LineMovePoint1(this.Indicator, this.ParameterPanel.ColumnLineAnchorMode, this.Point);
        ...
        private void Single6()
        {
            switch (this.PanelMode)
            {
                case BoxContainsNodeMode.None:
                    ...
                    break;
                case BoxContainsNodeMode.Contains:
                    this.Composer.PanelTranslate(this.Indicator, this.ParameterPanel.PanelAnchorMode, this.StartingPoint, this.Point);
                ...
                case BoxContainsNodeMode.HandleRightBottom:
                    if (this.HasStepFrequency)
                        this.Composer.PanelRotate(this.Indicator, this.ParameterPanel.PanelAnchorMode, this.Point, StepFrequency);
                    else
                        this.Composer.PanelRotate(this.Indicator, this.ParameterPanel.PanelAnchorMode, this.Point);
                ...
                case BoxContainsNodeMode.HandleBottom:
                    this.Composer.PanelTransformSkew(this.Indicator, this.ParameterPanel.PanelAnchorMode, this.Point, this.NodeKeepRatio, this.NodeCenteredScaling);
                    ...
                    break;
                default:
                    this.Composer.PanelTransformSize(this.Indicator, this.ParameterPanel.PanelAnchorMode, this.Point, this.NodeKeepRatio, this.NodeCenteredScaling);
        ...
        private void CacheSingle0()
        {
            ...
            switch (this.Mode)
            {
                ...
                case BoxContainsNodeMode.HandleRightTop:
                case BoxContainsNodeMode.HandleLeftBottom:
                case BoxContainsNodeMode.HandleRightBottom: this.Transformer.CacheRotation(this.StartingPoint); break;

                case BoxContainsNodeMode.HandleLeft: this.Transformer.CacheTransform(TransformMode.SkewLeft); break;
                case BoxContainsNodeMode.HandleTop: this.Transformer.CacheTransform(TransformMode.SkewTop); break;
            ...
            foreach (Layer item in this.Layers)
            {
                if (item.IsEditable)
                {
                    ...
                    figure.Segments.Add(new Segment
                    {
                        ...
                        Raw = new Node(this.StartingPoint),
                        Map = new Node(this.StartingPoint),
                    });
        ...
        private void PenCurve(List<Segment> items)
        {
            items[items.Count - 1] = new Segment
            {
                IsChecked = true,
                IsSmooth = true,
                Starting = new Node(this.Point),

                Raw = new Node(this.Point),
                Map = new Node(this.Point),
            };

            Segment segment = items[items.Count - 2];
            if (segment.IsSmooth)
            {
                this.Smooth = new NodeSmooth(items[items.Count - 3].Raw.Point, segment.Raw.Point, this.Point);

                items[items.Count - 2] = new Segment
                {
                    IsChecked = true,
                    IsSmooth = true,
                    Starting = this.Smooth.Node,

                    Raw = this.Smooth.Node,
                    Map = this.Smooth.Node,
                };
            }
        }
        ...
        private bool ContainsPoint(Layer item, Vector2 point)
        {
            ...
            for (int i = 0; i < item.Figures.Count; i++)
            {
                ...
                this.Closest = new Curves.ClosestPointer(figure.Segments, figure.IsClosed, point, ls);
                ...
                if (item.IsSelected)
                {
                    foreach (Figure figure in item.Figures)
                    {
                        foreach (Segment segment in figure.Segments)
                        {
                            if (segment.IsChecked)
                            {
                                drawingSession.DrawLine(segment.Map.Point, segment.Map.LeftControlPoint, Windows.UI.Colors.DeepSkyBlue);
                                drawingSession.DrawLine(segment.Map.Point, segment.Map.RightControlPoint, Windows.UI.Colors.DeepSkyBlue);
                            }
                        }
                    }
                    ...
                    foreach (Figure figure in item.Figures)
                    {
                        foreach (Segment segment in figure.Segments)
                        {
                            if (segment.IsChecked)
                                ...
                                drawingSession.DrawNode3(segment.Map.Point);
                        }
                    }
                }
            }
        ...
        private void Draw2(ICanvasResourceCreator resourceCreator, CanvasDrawingSession drawingSession)
        {
            ...
            {
                Vector2 f = this.Closest.Current.Point;
                ...
                {
                    Vector2 e = this.Closest.Previous.Point;
                    Vector2 n = this.Closest.Next.Point;
            ...
            foreach (Layer item in this.Layers)
            {
                if (item.IsSelected)
                {
                    foreach (Figure figure in item.Figures)
                    {
                        ...
                        {
                            if (segment.IsChecked)
                                drawingSession.DrawNode(segment.Map.Point);
                            else
                                drawingSession.DrawNode3(segment.Map.Point);
                        }
                    }
                        ...
                        if (item.IsSelected)
                        {
                            for (int j = 0; j < item.Figures.Count; j++)
                            {
                                ...
                                if (this.Indexer.Mode != SegmentIndexerMode.None)
                                {
                                    ...
                                    if (this.Indexer.Mode == SegmentIndexerMode.LeftControlPoint) goto case SegmentIndexerMode.LeftControlPoint;
                                    if (this.Indexer.Mode == SegmentIndexerMode.RightControlPoint) goto case SegmentIndexerMode.RightControlPoint;
                                }
                            }
                        }
                    }
                    ...
                    for (int k = 0; k < this.Layers.Count; k++)
                    {
                        ...
                        if (item.IsSelected)
                        {
                            for (int j = 0; j < item.Figures.Count; j++)
                            {
                                ...
                                this.Inserter = new SegmentInserter(out this.Closest, figure.Segments, figure.IsClosed, this.Point, ls);
                                ...
                                if (this.Inserter.Mode == SegmentInserterMode.Smooth)
                                {
                                    figure.Segments[this.Inserter.Previous] = new Segment
                                    {
                                        ...
                                        Raw = Node.Transform(this.Closest.Previous, item.HomographyInverseMatrix),
                                    ...
                                    figure.Segments[this.Inserter.Next] = new Segment
                                    {
                                        ...
                                        Raw = Node.Transform(this.Closest.Next, item.HomographyInverseMatrix),
                                        Map = this.Closest.Next,
                                    };
                                }
                                ...
                                figure.Segments.Insert(this.Inserter.Current, new Segment
                                {
                                    ...
                                    Raw = Node.Transform(this.Closest.Current, item.HomographyInverseMatrix),
                                    Map = this.Closest.Current,
                                });
                ...
                case SegmentIndexerMode.RightControlPoint:
                    {
                        ...
                        figure.Segments[this.Indexer.Index] = new Segment
                        {
                            ...
                            Starting = segment.Map,

                            Raw = segment.Raw,
                            Map = segment.Map,
                        };

                        item.Complete(figure);
                        item.UpdateCanvas();
                ...
                case SegmentIndexerMode.RightControlPoint:
                    {
                        ...
                        Figure figure = item.Figures[this.FigureIndex];
                        Segment segment = figure.Segments[this.Indexer.Index];
                        Node map = this.Controller.ToNode(this.Point, this.Disconnected);
                        ...
                        figure.Segments[this.Indexer.Index] = new Segment
                        {
                            ...
                            Raw = Node.Transform(map, item.HomographyInverseMatrix),
                            Map = map,
                        };
                        ...
                        for (int k = 0; k < this.Layers.Count; k++)
                        {
                            ...
                            if (item.IsSelected)
                            {
                                for (int j = 0; j < item.Figures.Count; j++)
                                {
                                    ...
                                    this.Closest = new ClosestPointer(figure.Segments, figure.IsClosed, this.Point, ls);
                                    if (this.Closest.Contains)
                                    {
                                        this.Invalidate(InvalidateModes.CanvasControl);
                                        return;
