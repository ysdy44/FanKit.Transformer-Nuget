...
using LineContainsNodeMode = FanKit.Transformer.Cache.LineContainsNodeMode0;
using BoxContainsNodeMode = FanKit.Transformer.Cache.BoxContainsNodeMode0;

namespace FanKit.Transformer.TestApp
{
    /// <summary>
    /// <see cref="DemoHostComposer0"/>
    /// </summary>
    public sealed partial class Curves0Page : SoloPage
    {
        //@Key
        ...
        readonly DemoHostTriangle0 Transformer = new DemoHostTriangle0();
        ...
        readonly DemoHostComposer0 Composer = new DemoHostComposer0();
