...
using Layer = FanKit.Transformer.Demos.DemoPolyline2;
...
namespace FanKit.Transformer.TestApp
{
    ...
    /// </summary>
    public sealed partial class Polylines3Page : SoloPage
    {
        //@Key
                    ...
                    foreach (Figure figure in item.Figures)
                    {
                        foreach (Segment segment in figure.Segments)
                        {
                            if (segment.IsChecked)
                                ...
                                drawingSession.DrawNode3(segment.Map);
                        }
                    }
                }
            }
                    ...
                    for (int k = 0; k < this.Layers.Count; k++)
                    {
                        ...
                        if (item.IsSelected)
                        {
                            for (int j = 0; j < item.Figures.Count; j++)
                            {
                                ...
                                this.Inserter = new SegmentInserter(out this.FootPoint, figure.Segments, figure.IsClosed, this.Point, ls);
