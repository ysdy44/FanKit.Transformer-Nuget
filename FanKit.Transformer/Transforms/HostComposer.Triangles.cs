...
namespace FanKit.Transformer.Transforms
{
    partial class HostComposer
    {
        ...
        public void PanelSetTranslation(IIndicator indicator, BoxMode mode, Vector2 translate) => this.Panel.ST1(indicator, mode, translate);

        public void PanelSetTranslationX(float translateX) => this.Panel.STX0(translateX);
        public void PanelSetTranslationX(IIndicator indicator, BoxMode mode, float translateX) => this.Panel.STX1(indicator, mode, translateX);

        public void PanelSetTranslationY(float translateY) => this.Panel.STY0(translateY);
        public void PanelSetTranslationY(IIndicator indicator, BoxMode mode, float translateY) => this.Panel.STY1(indicator, mode, translateY);

        public void PanelSetTransform(Matrix3x2 matrix) => this.Panel.SF0(matrix);
        public void PanelSetTransform(IIndicator indicator, BoxMode mode, Matrix3x2 matrix) => this.Panel.SF1(indicator, mode, matrix);

        public void PanelSetWidth(IIndicator indicator, BoxMode mode, float value, bool keepRatio) => this.Panel.SW(indicator, mode, value, keepRatio);
        public void PanelSetHeight(IIndicator indicator, BoxMode mode, float value, bool keepRatio) => this.Panel.SH(indicator, mode, value, keepRatio);

        public void PanelSetRotation(IIndicator indicator, BoxMode mode, float rotationAngleInDegrees) => this.Panel.SR(indicator, mode, rotationAngleInDegrees);
        public void PanelSetSkew(IIndicator indicator, BoxMode mode, float skewAngleInDegrees, float minimum = -85f, float maximum = 85f) => this.Panel.SS(indicator, mode, skewAngleInDegrees, minimum, maximum);
        #endregion
        ...
        public void PanelTranslate(IIndicator indicator, BoxMode mode, Vector2 startingPoint, Vector2 point) => this.Panel.TD1(indicator, mode, startingPoint, point);

        public void PanelTranslate(Vector2 translate) => this.Panel.T0(translate);
        public void PanelTranslate(IIndicator indicator, BoxMode mode, Vector2 translate) => this.Panel.T1(indicator, mode, translate);

        public void PanelTranslate(float translateX, float translateY) => this.Panel.TXY0(translateX, translateY);
        public void PanelTranslate(IIndicator indicator, BoxMode mode, float translateX, float translateY) => this.Panel.TXY1(indicator, mode, translateX, translateY);

        public void PanelTranslateX(float translateX) => this.Panel.TX0(translateX);
        public void PanelTranslateX(IIndicator indicator, BoxMode mode, float translateX) => this.Panel.TX1(indicator, mode, translateX);

        public void PanelTranslateY(float translateY) => this.Panel.TY0(translateY);
        public void PanelTranslateY(IIndicator indicator, BoxMode mode, float translateY) => this.Panel.TY1(indicator, mode, translateY);

        public void PanelTransform(Matrix3x2 matrix) => this.Panel.F0(matrix);
        public void PanelTransform(IIndicator indicator, BoxMode mode, Matrix3x2 matrix) => this.Panel.F1(indicator, mode, matrix);
        #endregion
        ...
        public void PanelTransformSize(IIndicator indicator, BoxMode mode, Vector2 point, bool keepRatio, bool centeredScaling) => this.Panel.TWH1(indicator, mode, point, keepRatio, centeredScaling);
        ...
        public void PanelTransformSkew(IIndicator indicator, BoxMode mode, Vector2 point, bool keepRatio, bool centeredScaling) => this.Panel.TS1(indicator, mode, point, keepRatio, centeredScaling);
        #endregion
    }
}