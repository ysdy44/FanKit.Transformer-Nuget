    ...
    public class DemoHostComposer0 : HostComposer
    {
        ...
        public void UpdateCanvas()
        {
            switch (this.SizeType)
            {
                ...
                case SizeType.RowLine:
                    this.ActualPoint = default;
                    this.ActualLine = new Line0(this.LinePoint0, this.LinePoint1);
                    this.ActualBox = default;
                    break;
                ...
                case SizeType.Panel:
                    this.ActualPoint = default;
                    this.ActualLine = default;
                    this.ActualBox = new Box0(this.PanelDestination);
                    break;
                default:
                    this.ActualPoint = default;
                    this.ActualLine = default;
        ...
        public void UpdateCanvas(ICanvasMatrix canvasMatrix)
        {
            switch (this.SizeType)
            {
                ...
                case SizeType.RowLine:
                    this.ActualPoint = default;
                    this.ActualLine = new Line0(this.LinePoint0, this.LinePoint1, canvasMatrix);
                    this.ActualBox = default;
                    break;
                case SizeType.ColumnLine:
                    this.ActualPoint = default;
                ...
                case SizeType.Panel:
                    this.ActualPoint = default;
                    this.ActualLine = default;
                    this.ActualBox = new Box0(this.PanelDestination, canvasMatrix);
                    break;
                default:
                    this.ActualPoint = default;
                    this.ActualLine = default;
