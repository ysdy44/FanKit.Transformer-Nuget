...
namespace FanKit.Transformer.Cache
{
    partial struct Box2
    {
        ...
        private Box2(Vector2 leftTop, Vector2 rightTop, Vector2 leftBottom, Vector2 rightBottom, float handleLength)
        {
            // Corners
        ...
        public Box2(Bounds bounds, ICanvasInverseMatrix inverseMatrix, float handleLength = 32f)
        ...
        public Box2(Triangle triangle, float handleLength = 32f)
        ...
        public Box2(Triangle triangle, ICanvasInverseMatrix inverseMatrix, float handleLength = 32f)
        ...
        public Box2(Quadrilateral quad, float handleLength = 32f)
            : this(quad.LeftTop,
                  quad.RightTop,
                  quad.LeftBottom,
                  quad.RightBottom,
        ...
        public Box2(Quadrilateral quad, ICanvasInverseMatrix inverseMatrix, float handleLength = 32f)
        ...
        public static implicit operator Triangle(Box2 box)
        {
            return new Triangle
            {
                LeftTop = box.LeftTop,
        ...
        public static implicit operator Quadrilateral(Box2 box)
        {
