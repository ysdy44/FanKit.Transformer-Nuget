    ...
    public readonly partial struct Box1
    {
        ...
        public BoxContainsNodeMode1 ContainsNode(Vector2 point, float minSelectedLengthSquared = 144f, float minSideLengthSquared = 144f)
        {
            ...
            if (i2 < minSelectedLengthSquared)
                return BoxContainsNodeMode1.HandleBottom;
            ...
            if (j2 < minSelectedLengthSquared)
                return BoxContainsNodeMode1.HandleRight;
            ...
            if (k2 < minSelectedLengthSquared)
                return BoxContainsNodeMode1.HandleTop;
            ...
            if (l2 < minSelectedLengthSquared)
                return BoxContainsNodeMode1.HandleLeft;
            ...
            if (m2 < minSelectedLengthSquared)
                return BoxContainsNodeMode1.HandleRightBottom;
            ...
            if (n2 < minSelectedLengthSquared)
                return BoxContainsNodeMode1.HandleLeftBottom;
            ...
            if (o2 < minSelectedLengthSquared)
                return BoxContainsNodeMode1.HandleRightTop;
            ...
            if (p2 < minSelectedLengthSquared)
                return BoxContainsNodeMode1.HandleLeftTop;
             */
