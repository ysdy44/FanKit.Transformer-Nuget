...
{
    public readonly partial struct Box3
    {
        ...
        public BoxContainsNodeMode3 ContainsNode(Vector2 point, float minSelectedLengthSquared = 144f, float minSideLengthSquared = 144f)
        {
            float x = point.X;
            float y = point.Y;
            ...
            if (a2 < minSelectedLengthSquared)
                return BoxContainsNodeMode3.RightBottom;
            ...
            if (b2 < minSelectedLengthSquared)
                return BoxContainsNodeMode3.LeftBottom;
            ...
            if (c2 < minSelectedLengthSquared)
                return BoxContainsNodeMode3.RightTop;
            ...
            if (d2 < minSelectedLengthSquared)
                return BoxContainsNodeMode3.LeftTop;
            ...
            if (this.SideBottomLengthSquared > minSideLengthSquared)
            {
                ...
                if (e2 < minSelectedLengthSquared)
                    return BoxContainsNodeMode3.CenterBottom;
            }
            ...
            if (this.SideRightLengthSquared > minSideLengthSquared)
            {
                ...
                if (f2 < minSelectedLengthSquared)
                    return BoxContainsNodeMode3.CenterRight;
            }
            ...
            if (this.SideTopLengthSquared > minSideLengthSquared)
            {
                ...
                if (g2 < minSelectedLengthSquared)
                    return BoxContainsNodeMode3.CenterTop;
            }
            ...
            if (this.SideLeftLengthSquared > minSideLengthSquared)
            {
                ...
                if (h2 < minSelectedLengthSquared)
                    return BoxContainsNodeMode3.CenterLeft;
            }
            ...
            if (i2 < minSelectedLengthSquared)
                return BoxContainsNodeMode3.HandleBottom;
            ...
            if (j2 < minSelectedLengthSquared)
                return BoxContainsNodeMode3.HandleRight;
            ...
            if (k2 < minSelectedLengthSquared)
                return BoxContainsNodeMode3.HandleTop;
            ...
            if (l2 < minSelectedLengthSquared)
                return BoxContainsNodeMode3.HandleLeft;
            ...
            if (m2 < minSelectedLengthSquared)
                return BoxContainsNodeMode3.HandleRightBottom;
            ...
            if (n2 < minSelectedLengthSquared)
                return BoxContainsNodeMode3.HandleLeftBottom;
            ...
            if (o2 < minSelectedLengthSquared)
                return BoxContainsNodeMode3.HandleRightTop;
            ...
            if (p2 < minSelectedLengthSquared)
                return BoxContainsNodeMode3.HandleLeftTop;
            ...
            switch (Comparer<float>.Default.Compare((d.X - b.X) * (y - b.Y), (d.Y - b.Y) * (x - b.X)))
            {
                case 1:
                    if ((c.X - d.X) * (y - d.Y) > (c.Y - d.Y) * (x - d.X) &&
                        (a.X - c.X) * (y - c.Y) > (a.Y - c.Y) * (x - c.X) &&
                        (b.X - a.X) * (y - a.Y) > (b.Y - a.Y) * (x - a.X))
                        return BoxContainsNodeMode3.Contains;
                    else
                        return BoxContainsNodeMode3.None;
                case -1:
                    if ((c.X - d.X) * (y - d.Y) < (c.Y - d.Y) * (x - d.X) &&
                        (a.X - c.X) * (y - c.Y) < (a.Y - c.Y) * (x - c.X) &&
                        (b.X - a.X) * (y - a.Y) < (b.Y - a.Y) * (x - a.X))
