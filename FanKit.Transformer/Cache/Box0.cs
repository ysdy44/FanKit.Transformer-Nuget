        ...
        public BoxContainsNodeMode0 ContainsNode(Vector2 point, float minSelectedLengthSquared = 144f, float minSideLengthSquared = 144f)
        {
            ...
            if (this.SideBottomLengthSquared > minSideLengthSquared)
            {
                ...
                if (e2 < minSelectedLengthSquared)
                    return BoxContainsNodeMode0.CenterBottom;
            }
            ...
            if (this.SideRightLengthSquared > minSideLengthSquared)
            {
                ...
                if (f2 < minSelectedLengthSquared)
                    return BoxContainsNodeMode0.CenterRight;
            }
            ...
            if (this.SideTopLengthSquared > minSideLengthSquared)
            {
                ...
                if (g2 < minSelectedLengthSquared)
                    return BoxContainsNodeMode0.CenterTop;
            }
            ...
            if (this.SideLeftLengthSquared > minSideLengthSquared)
            {
                ...
                if (h2 < minSelectedLengthSquared)
                    return BoxContainsNodeMode0.CenterLeft;
            }
            ...
            if (i2 < minSelectedLengthSquared)
                return BoxContainsNodeMode0.HandleBottom;
            ...
            if (j2 < minSelectedLengthSquared)
                return BoxContainsNodeMode0.HandleRight;
            ...
            if (k2 < minSelectedLengthSquared)
                return BoxContainsNodeMode0.HandleTop;
            ...
            if (l2 < minSelectedLengthSquared)
                return BoxContainsNodeMode0.HandleLeft;
            ...
            if (m2 < minSelectedLengthSquared)
                return BoxContainsNodeMode0.HandleRightBottom;
            ...
            if (n2 < minSelectedLengthSquared)
                return BoxContainsNodeMode0.HandleLeftBottom;
            ...
            if (o2 < minSelectedLengthSquared)
                return BoxContainsNodeMode0.HandleRightTop;
            ...
            if (p2 < minSelectedLengthSquared)
                return BoxContainsNodeMode0.HandleLeftTop;
            */
