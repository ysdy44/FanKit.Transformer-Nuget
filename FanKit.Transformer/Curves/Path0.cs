...
namespace FanKit.Transformer.Curves
{
    public partial class Path0
    {
        ...
        private void Extend()
        {
            ...
            {
                Segment0 previous = this.Data[i - 1];
                Segment0 next = this.Data[i];

                this.b = Segment0.Extend(previous, next);
            ...
            if (this.IsClosed)
            {
                ...
                Segment0 last = this.Data[this.Data.Count - 1];

                this.b = Segment0.Extend(last, first);
                this.SourceBounds = Bounds.Union(this.SourceBounds, this.b);
            }
        }
