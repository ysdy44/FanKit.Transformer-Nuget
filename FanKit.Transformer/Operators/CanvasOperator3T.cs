...
{
    public abstract class CanvasOperator3<T>
    {
        public event SingleStartedEventHandler<T> Single_Start = null;
        ...
        public void PressedPen(uint pointerId, double x, double y, T properties)
        {
            ...
            this.Single_Start?.Invoke(this.FlipX(this.SPX), this.SPY, this.PX, this.PY, properties);
        }
        #endregion
