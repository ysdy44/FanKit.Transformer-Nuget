...
namespace FanKit.Transformer.Input
{
    ...
    // Scale
    // Translation
    public partial class CanvasTransformer2 : ICanvasMatrix, ICanvasInverseMatrix
    {
        ...
        public CanvasTransformer2(float centerX, float centerY) => SetCenter(centerX, centerY);
